...
export const metadata: Metadata = {
  title: 'Texas Business Organizations Alliance | Claim Your Organization Listing',
  description: 'The Texas Business Organizations Alliance (TBOA) is a statewide network of verified chambers, networking groups, and professional associations across Texas. Claim your organization listing to join.',
};
...
const FEATURES = [
  ...
  { icon: 'ti-network',            title: 'Statewide Alliance',  desc: 'All city chapters roll up into the Texas Business Organizations Alliance, creating cross-city visibility and connection across the state.' },
...
const STEPS = [
  ...
  { num: '3', icon: 'ti-star',        title: 'You are a member',       desc: 'Once approved, your organization becomes a verified member of your city chapter and the Texas Business Organizations Alliance. Free to start.' },
];
    ...
    <>
      ...
      <main style={{ flex: 1 }}>
        ...
        <section style={{ background: 'var(--color-ink)', padding: '64px 32px 56px', borderBottom: '1px solid rgba(255,255,255,.08)' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(2.25rem, 5vw, 3.25rem)', fontWeight: 700, color: '#fff', lineHeight: 1.1, letterSpacing: '-0.025em', marginBottom: '20px' }}>
              Texas Business Organizations Alliance
            </h1>
            <p style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,.65)', lineHeight: 1.75, maxWidth: '600px', marginBottom: '32px' }}>
              A statewide alliance of verified chambers of commerce, professional associations, and networking groups across every major Texas city. Claim your organization's listing and join the TBOA — free to start.
            </p>
        ...
        <section style={{ padding: '64px 32px', maxWidth: '860px', margin: '0 auto' }}>
          <div className="m-stack" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '48px', alignItems: 'start' }}>
            <div>
              <div style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--color-primary)', marginBottom: '14px' }}>What is the TBOA?</div>
              <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.75rem', fontWeight: 700, color: 'var(--fg-1)', lineHeight: 1.2, marginBottom: '16px' }}>
                One alliance for every business organization in Texas
              </h2>
              <p style={{ fontSize: '14px', color: 'var(--fg-3)', lineHeight: 1.8, marginBottom: '16px' }}>
                The Texas Business Organizations Alliance (TBOA) is a statewide alliance built on top of the Local Business Organizations directory. When your organization claims its listing, you become part of both your <strong style={{ color: 'var(--fg-1)' }}>local city chapter</strong> and the broader <strong style={{ color: 'var(--fg-1)' }}>Texas Business Organizations Alliance</strong>.
              </p>
            ...
            {CHAPTERS.map(ch => (
              <div key={ch.city} style={{ background: 'var(--color-paper-2)', border: '1px solid var(--color-rule)', borderRadius: '12px', padding: '24px', display: 'flex', flexDirection: 'column', gap: '10px', position: 'relative', overflow: 'hidden' }}>
                ...
                <p style={{ fontSize: '13px', color: 'var(--fg-3)', lineHeight: 1.6, margin: 0, position: 'relative' }}>
                  {ch.city} chapter of the Texas Business Organizations Alliance — open to all verified business organizations in the {ch.city} metro area.
                </p>
