...
export const metadata: Metadata = {
  title: 'Texas Business Organizations | Now Forming — Statewide Network',
  description: 'Texas Business Organizations is a statewide network connecting chambers, networking groups, and professional associations across every major Texas city. Now forming — claim your listing to join.',
};
      ...
      <main style={{ flex: 1 }}>
        ...
        <section style={{ background: 'var(--color-ink)', padding: '64px 32px 56px', borderBottom: '1px solid rgba(255,255,255,.08)' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,.65)', lineHeight: 1.75, maxWidth: '600px', marginBottom: '32px' }}>
              A statewide network connecting chambers of commerce, professional associations, and networking groups across every major Texas city. One network. Four cities. Thousands of organizations.
            </p>
        ...
        <section style={{ padding: '64px 32px', maxWidth: '860px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '48px', alignItems: 'start' }}>
            <div>
              <div style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--color-primary)', marginBottom: '14px' }}>What is TBO?</div>
              ...
              <p style={{ fontSize: '14px', color: 'var(--fg-3)', lineHeight: 1.8, marginBottom: '16px' }}>
                Texas Business Organizations (TBO) is a statewide membership network built on top of the Local Business Organizations directory. When your organization claims its listing, you become part of both your <strong style={{ color: 'var(--fg-1)' }}>local city chapter</strong> and the broader <strong style={{ color: 'var(--fg-1)' }}>TBO statewide network</strong>.
              </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {[
                ...
                ['🌐', 'Statewide Network', 'All city chapters roll up into the Texas Business Organizations statewide network, creating cross-city visibility and connection.'],
            ...
            {CHAPTERS.map(ch => (
              <div key={ch.city} style={{ background: '#fff', border: '1px solid var(--color-rule)', borderRadius: '12px', padding: '24px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                ...
                <p style={{ fontSize: '13px', color: 'var(--fg-3)', lineHeight: 1.6, margin: 0 }}>
                  {ch.city} chapter of Texas Business Organizations — open to all verified business organizations in the {ch.city} metro area.
                </p>
        ...
        <section style={{ padding: '64px 32px', maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '36px' }}>
            {[
              ...
              ['3', 'You are a member', 'Once approved, your organization becomes a verified member of your city chapter and the TBO statewide network. Free to start.'],
            ].map(([num, title, desc]) => (
